...
summary: "Using the Jing-Zhang Railway heritage corridor as the innovation main axis, connecting three cores — Wisdom Valley (Zhongzhiyuan), Source Community (AI Origin), and Bell Boundary (Dazhongsi) — to build a world-class AI ecosystem innovation corridor integrating full-stack AI R&D, scenario empowerment, public space, cultural narrative, and long-term operation. Core proposition 'City Intelligent Being' — responding to the brief's three development goals (world-class AI innovation district, global AI industry hub, City Intelligent Being demonstration zone), with the four properties learnable/evolvable/open/implementable as spatial method, realizing 'three belts in one' across the Centennial Jing-Zhang Cultural Belt, the Urban AI Lifestyle Experience Belt, and the AI Converged Innovation Belt. Two AI mechanisms that reshape physical space: ① AI-reshaped street section with dynamic right-of-way (motor right-of-way 52.5%→32.5%, slow+shared 25%→45%); ② AI governance driving public space operation loop (sense–diagnose–suggest–act four-step closed loop). Ecosystem innovation lever 'AI-native OPC' — echoing Haidian's Zhongguancun AI Beipro Community, which launched Beijing's first AI OPC (One-Person Company) service plan, upgrading the one-person company model from a park-level incubator system to city-scale innovation infrastructure: OPC ecosystem modules covering all 12 neighborhood centers, with 'one person + AI agent team' enabling start-a-business-downstairs and scenario-as-market. Core concept 'Innovation Circle' — universities are innovation sources, the corridor connects innovation sources, three cores are innovation agglomeration nodes, three rings (blue-green slow-mobility ring + innovation liaison ring + AI service ring) form the innovation circulation circle, and AI scenarios are intelligent perception terminals. Spatial structure 'one corridor, three cores, two wings, three rings', urban renewal 'retain-renovate-demolish-new' four-tier classification, phased implementation in three stages: Foundation — Chain — Ecosystem."
...
**One Proposition — City Intelligent Being**: The brief directs this solicitation toward three development goals — "a world-class AI innovation district, a global AI industry hub, and a City Intelligent Being demonstration zone" [source:AGENT-TASKBOOK]. This proposal's spatial answer is: a city should not merely be a container hosting AI scenarios, but should itself become a **learnable, evolvable, open, and implementable City Intelligent Being**. Accordingly, the proposal uses the Jing-Zhang Railway heritage corridor as a single innovation axis connecting three cores — Wisdom Valley/Zhongzhiyuan AI Acceleration Zone (192.1 ha), Source Community/Beijing AI Origin Community (104.3 ha), and Bell Boundary/Dazhongsi AI Industry Zone (72.0 ha) — to realize "three belts in one" across the brief's three positioning goals: **the Centennial Jing-Zhang Cultural Belt**, using the ~9.2 km heritage corridor as a historical narrative corridor so that a century of indigenous-innovation heritage becomes the cultural core of the City Intelligent Being; **the Urban AI Lifestyle Experience Belt**, using the three cores' 3.684 km² as priority areas to translate AI into everyday experience perceivable by AI talent, enterprises, and residents; and **the AI Converged Innovation Belt**, mobilizing universities, parks, enterprises, and communities across the 43.6 km² coordinated scope to build a world-class AI innovation ecosystem integrating full-stack AI R&D, scenario empowerment, public space, cultural narrative, and long-term operation.

**The Four Properties Implemented**: Openness — all three cores are designed as wall-less open innovation blocks, with branch-road density ≥10 km/km², block scale of 80–120 m, and every point within a 5-minute walk of a public transit stop; Learnability — the "Innovation Circle" mechanism channels university innovation sources along the corridor and back through the three rings, enabling the city to continuously learn and self-correct through AI scenario operations; Evolvability — the "retain-renovate-demolish-new" four-tier renewal classification combined with the three-phase "Foundation — Chain — Ecosystem" implementation enables the city to evolve with demand; Implementability — the 18 renewal project matrix, 12 AI scenario nodes, and 43 measurable indicators are all premised on being independently verifiable with public data.

**Core Concept — "Innovation Circle"**: Universities are innovation sources, the corridor connects innovation sources, three cores are innovation agglomeration nodes, three rings (blue-green slow-mobility ring + innovation liaison ring + AI service ring) form the innovation circulation circle, and AI scenarios are intelligent perception terminals. This concept is not decorative naming but the logic of spatial organization — innovation resources originate from universities, flow along the corridor, converge at nodes, radiate through wings, and connect as a whole via the innovation circle. It is also the spatial carrier of the City Intelligent Being's "learnability" property: AI scenarios function both as service terminals and as the city's perception-and-feedback units.
...
- **AI ecosystem innovation lever — the "AI-native OPC" one-person company model**: In December 2025, Haidian's Zhongguancun AI Beipro Community launched Beijing's first AI OPC service plan [source:SRC-2026-ZGC-OPC-PLAN]. This proposal upgrades the OPC (One-Person Company) from a park-level incubator system into city-scale innovation infrastructure — OPC ecosystem modules cover all 12 neighborhood centers (light-start space anchor nodes at all 8 Level-1 centers); the "one person + AI agent team" organizational form enables "start a business downstairs, live within five minutes, scenario as market," cultivating "super individuals" as the micro-cells of the global AI industry hub
...
- **The corridor connects innovation sources**: The Jing-Zhang heritage park innovation main axis runs ~9.2 km north-south, serving as a composite carrier of cultural narrative, public space, and slow-mobility transportation, and as the spatial axis connecting university innovation sources with the three cores. AI scenario nodes, open-source galleries, developer walking paths, and AI agent contribution honor walls are deployed along the corridor, enabling innovation resources to flow and converge.
...
**One-Sentence Testable Criterion**: The Innovation Circle stands or falls on two measurable indicators: the local commercialization rate of university research outcomes (not lower than 40%) and the 15-minute public transit accessibility rate between corridor innovation nodes (not lower than 90%). If either indicator fails, the corresponding corridor segment's spatial arrangement is rolled back—success is never measured by new floor area or company registration counts.

Verification method: the local commercialization rate = value of technology transfer contracts to local universities received within the corridor's three core areas / total value of local universities' technology transfer contracts (source: Beijing technology contract registration data, annual); the 15-minute accessibility rate = share of innovation nodes reachable from any other innovation node within 15 minutes by public transit (source: recalculated from transit operations data, rail + bus feeder). Both indicators can be independently recalculated from public data and verified on-site by reviewers.
...
- **Corridor** → The Jing-Zhang Railway heritage corridor serves as the innovation main axis, running ~9.2 km north-south, connecting university innovation sources, a composite carrier of cultural narrative, public space, and slow-mobility transportation
...
This section draws on the research "Connotation and Evolution Law of the World-class National Science City" from the Taihu Science City Strategic Planning and Conceptual Urban Design, focusing on its case studies of international and national science cities, to extract strategic insights for the Jing-Zhang AI Innovation Belt [source:EXTERNAL-REF-TAIHU-SCIENCE-CITY]. That research reviewed 10 representative science city / innovation center cases worldwide (Silicon Valley, New York, Boston, Cambridge, Daedeok, Munich, Tsukuba, Sophia Antipolis, One-North, etc.) and distilled nine evolution laws; this proposal retains only the mappings directly tied to spatial decisions — the complete case overview and the full text of the nine laws are available for reference in the external reference materials and are not used as formal evidence (evidence_class=background).

**Three Case Mappings Directly Tied to Spatial Decisions**

| Case Experience | Spatial Decision Basis | Proposal Landing Point |
|-----------------|------------------------|------------------------|
| NYC Silicon Alley: tech innovation returning to blocks, cafes and bookstores as the office network | Block permeability correlates positively with innovation density → determines the open innovation block model | "Open Innovation Block System" section: three principles of street permeability, functional mix, and transparent interfaces; differentiated design of the three cores |
| Munich + Tsukuba: full research-production chain progressing functionally along the corridor | Full-chain agglomeration requires a linear spatial carrier → determines the corridor's segmented layout | Wisdom Valley (basic research → applied R&D) → Source Community (scenario validation) → Bell Boundary (industrial transformation) three-core functional progression |
| Daedeok: government-led research institutions + market mechanism adjustment | Industry clusters need anchor facilities to drive them → determines Bell Boundary's industry anchor layout | Bell Boundary Dazhongsi AI industry cluster: dual anchors of enterprise accelerator + AI application demonstration center |

**Nine Evolution Patterns Index**

The nine evolution laws distilled by the Taihu Science City research (strengthen innovation element agglomeration, timely introduction of major science facilities, full-chain innovation function agglomeration, strengthen university-industry-research linkage, build advantageous industry clusters, improve creative incubation functions, build regional innovation clusters, improve innovation ecosystem collaboration, persist in city-industry integrated development) have been mapped item by item onto this proposal's spatial structure; the mapping is registered as an index table:

| Law | Corresponding Proposal Section / Spatial Decision |
|-----|--------------------------------------------------|
| Element agglomeration / university-industry-research linkage | "Coordinated Research Scope" section: three cores as element agglomeration anchors, university → corridor → three cores in-situ conversion chain |
| Major science facilities / full innovation chain | "Wisdom Valley / Zhongzhiyuan" section: AI computing center and evaluation platform, 9.2 km corridor functional progression |
| Advantageous industry clusters / creative incubation | "Bell Boundary / Dazhongsi" and "Two Wings" sections: East Wing AI + hard tech, West Wing AI + consumer services differentiated clusters |
| Regional innovation clusters / ecosystem collaboration | "Regional Coordination" and "AI Service Ring" sections: Line 13 corridor linkage with Zhongguancun, computing power, data, and compliance services |
| City-industry integration | "Open Innovation Block System" section: retain-renovate-demolish-new, open blocks, neighborhood center system |
...
### Pillar 3: AI-Native OPC Ecosystem Embedding — City-Scale Innovation Infrastructure for the One-Person Company

**Policy background**: In December 2025, Haidian's Zhongguancun AI Beipro Community, together with the Haidian Alumni Station and the Haidian college student internship & practice platform, launched Beijing's first AI OPC service plan. Guided by the philosophy of "lightweight start, agile trial-and-error, ecosystem empowerment," it builds a "1 super server + 4 empowerment pillars (space, service, tools, ecosystem) + 3-stage acceleration engines (financing, growth, industry)" cultivation system — the first systematic, full-lifecycle "one-person company" cultivation channel in China, enabling young entrepreneurs to "incubate AI with AI" [source:SRC-2026-ZGC-OPC-PLAN]. This marks OPC as an official industrial-organization innovation direction for Haidian in advancing the "AI+" initiative.

**This proposal's original upgrade — from "park OPC" to "city OPC"**: The existing OPC cultivation system is anchored in 6,000 m² of incubation space — still essentially "park logic." This proposal upgrades OPC to city-scale innovation infrastructure: an OPC is not an office, but a form of urban service relationship — the City Intelligent Being itself is the one-person company's "super partner." Implemented through five levels of embedding:

| Embedding level | Suzhou South Bank New Land prototype [source:EXTERNAL-REF-OPC] | Jing-Zhang "city OPC" upgrade |
|---|---|---|
| Spatial | OPC light-start spaces concentrated in innovation community | OPC ecosystem modules cover all 12 neighborhood centers, with light-start anchor nodes at all 8 Level-1 centers; "start a business downstairs" at talent apartment ground floors |
| Tools | Inclusive computing power, full-link large model tools | Inclusive edge computing nodes + an **Agent Store**: the OPC founder composes R&D, design, legal, tax, and marketing agents on demand, forming a "one person + agent team" zero-redundancy company |
| Scenarios | Scenario validation via park sandboxes | All 12 corridor AI scenario nodes open as OPC product proving grounds — **scenario as market**: products are validated, iterated, and acquire first users in real urban scenarios |
| Services | Government direct access, compliance outsourcing | One-stop access to government services, compliance outsourcing, and enterprise service agency; aligned with the Haidian OPC plan's three-stage acceleration engines, providing a start–growth–expansion full-cycle channel |
| Growth | Industry practice classrooms, growth stations | A three-tier "light-start space → accelerator → corporatization" growth channel; OPCs that scale up stay preferentially in the three cores' industry spaces, rooting the industrial ecosystem "born in the corridor, grown in the corridor" |

**Relationship to the "Innovation Circle"**: The OPC is the most mobile innovation subject in the Innovation Circle — smaller than an enterprise, more organized than an individual, entering the corridor's innovation circulation with minimal friction. Each neighborhood center's OPC ecosystem node is both a spatial anchor of the Innovation Circle and an industrial anchor of the City Intelligent Being's "learnability": agents developed by OPCs, once scenario-validated, can enter the Agent Store and be reused by more OPCs, forming an ecological inner loop of "develop — validate — list — reuse."

**Quantified targets**: OPC ecosystem module neighborhood-center coverage of 100% (12/12) [metric:opc_ecosystem_node_coverage]; referencing the Zhongguancun AI Beipro Community's momentum of nearly one hundred AI-native enterprises already gathered, target over 200 AI-native OPCs and micro-enterprises along the corridor by 2035, of which no fewer than 50% complete first-round product validation through the scenario market.
...
**One Corridor**: The Jing-Zhang heritage park innovation main axis, running ~9.2 km north-south, connecting three cores, is a composite carrier of cultural narrative, public space, and slow-mobility transportation [data:geometry/land_use.geojson#LU-007]. The corridor is not only green public space but the spatial main axis of the AI ecosystem innovation — with AI scenario nodes, open-source display galleries, developer walking paths, and agent contribution honor walls deployed along its length. The corridor's primary function is to connect university innovation sources (Tsinghua, BUAA, USTB, BUPT, BJTU) with the three cores' industrial transformation spaces, enabling innovation resources to flow and converge.
...
Based on the future user groups of the AI Innovation Belt, this proposal presents the following 6 user personas [source:AGENT-TASKBOOK]:
...
**Persona 6 - One-Person Company Founder "Lin Yi"**: 31 years old, former algorithm engineer at a major tech firm, now an AI-native OPC (One-Person Company) entrepreneur whose company is a "one person + agent team" of herself and 7 self-built AI agents (R&D, design, legal, tax, operations, customer service, marketing). Needs move-in-ready OPC light-start space, elastic computing power, and Agent Store tool composition, plus validation of products in real urban scenarios to acquire first users. Expects to "start a business downstairs, live within five minutes" in the AI Origin Community and to grow along the "light-start space → accelerator → corporatization" channel [source:SRC-2026-ZGC-OPC-PLAN].
...
### AI-Reshaped Street: From Static to Dynamic Right-of-Way

The "complete streets" approach is a continuation of the current motor-dominant right-of-way logic. For the 9.2 km corridor main axis and three-core key streets, this proposal advances an "AI-reshaped section" — materializing the right-of-way reallocation of the AI-mobility era into specific cross-section geometries [source:AGENT-TASKBOOK] [data:geometry/roads.geojson#RD-001]. Referencing a 40 m right-of-way urban arterial, five key changes occur after AI reshaping:

- **AV platooning narrows lanes to 3.25 m**: Autonomous vehicles in platoons reduce headway from 2.5s to 0.6s, *increasing* per-lane capacity by 1.5× — so a lane can be removed or narrowed. Two-way six lanes (3.5m) → two-way four lanes (3.25m), freeing ~7 m of roadway.
- **Delivery robots underground → return the sidewalk**: Robot delivery hubs along the corridor route bots through underground utility corridors and roadside dedicated lanes, replacing traditional van deliveries. Delivery no longer encroaches on slow-mobility right-of-way; the frontage returns to pedestrians.
- **Dynamic shared lane time-shared**: Beyond the binary "vehicle lane vs non-vehicle lane," a "dynamic shared lane" concept is introduced — the same surface carries delivery (8:00–10:00), outdoor dining (11:00–14:00), creative market (16:00–22:00), and temporary parking (22:00–6:00). An AI scheduling system allocates time windows based on real-time pedestrian and logistics demand.
- **AI service band as a new infrastructure layer**: A 2 m-wide AI service band on each side, between the sidewalk and roadway, integrates roadside sensors, edge computing, wireless charging, and V2X nodes. The street upgrades from "road engineering" to "sense-compute-respond integrated infrastructure."
- **5G-Advanced + cm-level positioning as safety margin**: 5G-A and BeiDou cm-level positioning achieve >99.9% reliability for the AI service band, V2X, and robot delivery, giving dynamic right-of-way allocation engineering-grade safety margins.

**Right-of-Way Reallocation Quantification (40 m arterial)**:

| Indicator | Current | AI-reshaped | Change |
| Motor right-of-way | 52.5% | 32.5% | -20% |
| Slow + shared right-of-way | 25% | 45% | +20% |
| Green + service band | 22.5% | 22.5% | unchanged |
| Lane count / width | Two-way 6 × 3.5m | Two-way 4 × 3.25m | AV narrowing |

Right-of-way reallocation is not about weakening mobility, but about **returning mobility to urban public-ness** — the most concrete spatial embodiment of the city intelligent being's "open" attribute [depth:transportation].

![AI-Reshaped Street Section: Current vs AI-reshaped](assets/figures/street-section.png)
...
### AI Governance Driving Public Space Operation Loop

If the digital twin is the "mirror brain" of the city, the AI governance operation loop is its "respiratory system" — translating data feedback into real-time adjustments of public space. AI is no longer used only for scenario demos, but becomes a co-decision partner in public space operation, shifting the city from "designed once, used statically" to "continuously learning, dynamically evolving" [source:AGENT-TASKBOOK].

**Four-step closed loop (sense–diagnose–suggest–act)**:

1. **Sense (real-time collection)**: The 12 AI scenario nodes and roadside AI service bands along the corridor and three cores continuously collect desensitized aggregated data — pedestrian density, activity type, dwell time, noise level, air quality, energy metrics. Data follows the minimization principle; no personal identity information is involved.
2. **Diagnose (anomaly identification)**: The digital twin compares real-time data against baseline models to identify three anomaly types — spatial underuse (resource waste), spatial overload (insufficient service capacity), spatial disorder (safety/quality issues). Diagnostic results are pushed to operators as "suggestion cards."
3. **Suggest (multi-option optimization)**: AI does not replace human decision-making. For each anomaly type, AI generates 2–3 candidate adjustment options — rearranging spatial elements, adding/removing furniture, flow guidance, lighting adjustment, etc. Each option comes with expected impact (e.g., "projected vacancy rate -12%") and potential side-effects (e.g., "night lighting downgrade may affect perceived safety").
4. **Act (community co-governance resolution)**: Adjustment suggestions enter a tripartite co-governance process: residents' council + property management + sub-district office. Suggestions affecting daily residents (e.g., plaza vending, night markets) require confirmation by the residents' representative council before execution. AI plays the "advisor" role, not the "decision-maker" — decision rights remain with people and community.

**Four spatial adaptive application scenarios**:

- **Dynamic shading and microclimate**: Based on pedestrian and weather data, smart shading pavilions in the AI service band automatically adjust louver angles — facing sun for winter warmth, shading for summer; misting facilities auto-activate on high-temperature days (>32°C).
- **Reconfigurable street furniture**: The corridor "Developer Walking Path" deploys modular seating, mobile greenery, smart charging stations. AI suggests layouts based on time-of-day activity patterns: clustered near green space in the morning, facing outdoor dining at noon, turning toward the plaza stage in the evening.
- **Time-shared right-of-way and plaza operation**: The "dynamic shared lane" in the section above is a street-level application; the same principle applies at plaza scale — the same plaza hosts community tai-chi at 8:00, maker lunch at 12:00, open-air cinema at 18:00, and night-run starting point at 22:00. AI schedules lighting, sound, and flow to fit each activity.
- **Adaptive narrative at AI pilgrimage landmarks**: The cultural exhibition system at Jing-Zhang Railway heritage nodes dynamically adjusts content depth based on visitor dwell time — casual visitors get 30-second audio guides, railway enthusiasts get 10-minute deep dives, AI developers see links to code and algorithm-related exhibits.

**Governance boundary and human review**: All AI adjustment suggestions require operator review; adjustments involving public safety and spatial order set a human review threshold; AI suggestion adoption rates are public operational performance metrics disclosed to the community [depth:innovation_ecosystem].
...
## Self-Verification and Correction Log

This proposal has established a correction mechanism of "self-check discovery → registration → disposition → re-verification" throughout its iterations. The three real corrections below all occurred during the v7.x to v8.x iterations; their dispositions have been consolidated into the current submission package, and reviewers can reproduce and verify them at the registered locations.

### Correction 1: Land-Use Coverage Gap and Overlap (LU-011)

- **Problem discovered**: In v8.0 self-checks, programmatic overlay recalculation of land-use parcels in geometry/land_use.geojson revealed a coverage gap between LU-010 and the adjacent land-use parcel — the sum of parcel areas was smaller than the site boundary area, leaving "holes" not covered by any land-use type.
- **Detection method**: Programmatic overlay verification (sum of parcel areas vs. site_boundary area, computed in the EPSG:4548 projection).
- **Impact scope**: The credibility of land-use structure share metrics in metrics.json; the claim that "land-use zoning covers the entire submitted boundary without gaps or overlaps" did not hold.
- **Disposition process**: Added land-use parcel LU-011 to fill the gap and simultaneously eliminated boundary overlaps with adjacent parcels; re-normalized the geometry_role field of the 7 geometry files to valid enumeration values.
- **Disposition result**: v8.0 verification fully green, zero coverage gaps. Reproduction location: the LU-011 feature in geometry/land_use.geojson; the "restored machine-generated artifacts" passage of the v8.0 entry in changelog.md.
- **Lesson registered**: The root cause of this type of error is the absence of topology-closure verification during parcel drawing. "Sum of parcels = boundary area" has been consolidated as a mandatory pre-submission check item.

### Correction 2: Duplicate green_ratio Metric Definition

- **Problem discovered**: Before v3.0, metrics.json contained two green_ratio entries, both passing off design_concept values (design concept values) as verified values — reviewers could not actually distinguish "measured baseline values" from "design target values."
- **Detection method**: AI Agent review feedback (a 58-point review noted metric classification confusion).
- **Impact scope**: Metric credibility; the accuracy of data-value declarations in visual/index.html.
- **Disposition process**: Merged the duplicate entries; introduced a baseline_value / target_value separation structure, re-labeling target values such as the 35% green space ratio from "concept values" to "design targets" (design_target), with value set to null (unknown) until measured evidence exists.
- **Disposition result**: In the current metrics.json, green_ratio is in known status with a value of 0.135242, recalculated from the submitted geometry in EPSG:4548; the data-value in visual/index.html is fully consistent with it. Reproduction location: the green_ratio entry in metrics.json; the "metrics.json restructuring" passage of the v3.0 entry in changelog.md.

### Correction 3: Dazhongsi Key-Area ID Mismatch

- **Problem discovered**: During v8.1 figure redrawing, the Dazhongsi node label in the site-overview figure displayed as "?" — the figure script's key_color_map used the old ID (dazhongsi_industry_area), whereas the actual ID in geometry/key_areas.geojson is dazhongsi_ai_industry_cluster.
- **Detection method**: Visual inspection after figure rendering revealed the missing label.
- **Impact scope**: Figure annotation accuracy; ID consistency among key_areas.geojson, the main text, and the figures.
- **Disposition process**: Unified on geometry/key_areas.geojson as the sole authoritative ID source; figure generation scripts changed to dynamically read area_id from GeoJSON properties, eliminating hardcoding.
- **Disposition result**: In the v8.2 figures, the Dazhongsi label displays correctly. Reproduction location: the dazhongsi_ai_industry_cluster feature in geometry/key_areas.geojson; the v8.2 entry in changelog.md.
- **Lesson registered**: ID references across figures, main text, and geometry must use the structured file as the single source of truth; hardcoding in multiple locations is prohibited.

**Correction mechanism statement**: These three corrections demonstrate this proposal's capacity for self-correction — problems are not hidden, but registered, dispositioned, and converted into pre-submission check items. All subsequent version iterations follow the same mechanism: problems discovered by self-checks have their disposition processes registered in changelog.md; unresolved problems are explicitly declared in metrics.json with unknown + reason; "declarative disclaimers" never replace actual verification.
...
All materials in this proposal are from public channels or repository-provided cleared materials [source:SRC-2026-BJ-GH-QUAL-PREANNOUNCEMENT]. No non-public-source government information, trade-secret materials, or personal information is used. All spatial boundaries use repository maintainer-provided provisional rough boundaries, clearly labeled as "provisional" [source:SRC-PROVISIONAL-BOUNDARIES-2026].
...
32. Zhongguancun AI Beipro Community launches AI OPC service plan (Beijing's first AI "one-person company" service plan), Haidian District People's Government portal, December 2025 (SRC-2026-ZGC-OPC-PLAN, https://www.bjhd.gov.cn/qyfw/bulletIndexDetail/1998591501383491584).
